...
-- REVOKE GRANT OPTION FOR ALL PRIVILEGES ON ALL TABLES IN SCHEMA public
-- FROM backend_linksapiweb;

-- ALTER DEFAULT PRIVILEGES REVOKE GRANT OPTION FOR ALL PRIVILEGES ON TABLES
-- FROM backend_linksapiweb;

-- Revoke the ability to create tables for all users
REVOKE 
    CREATE 
ON SCHEMA public
FROM PUBLIC;

-- Grant back the ability to create tables to Flyway migrations role
GRANT 
    CREATE 
ON SCHEMA public 
